...
experts. The median expert has $71$ assigned training rows, the
smallest retained expert has $10$, and the largest has $4{,}191$.
Each expert then fits expert-local input and output scalers and trains
eight exact GP heads, one for each flow-front frame. Validation rows
